                    ...
                    <div class="card-bod">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-lg-9">
                                <h5 class="card-title text-muted">Number of <br><span class="bold-text">Customers</span></h5>
                ...
                <div class="card rounded-10 border-0 mb-4 mb-lg-4">
                    <div class="card-bod">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-lg-9">
                                <h5 class="card-title text-muted">Number of <br><span class="bold-text">Products</span></h5>
                ...
                <div class="card rounded-10 border-0 mb-4 mb-lg-4">
                    <div class="card-bod">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-lg-9">
                                <h5 class="card-title text-muted">Number of <span class="bold-text">Appointments</span></h5>
                                <h3 class="card-title fw-bold">{{ $appointmentCounter }} Appointments</h3>
                            </div>
                        </div>
                    </div>
                </div>
