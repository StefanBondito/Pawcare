...
<div class="px-4 py-5 my-5 text-center">
    ...
    <h1 class="display-5 fw-bold text-body-emphasis">Pawcare</h1>
...
<div class="container px-4 py-5" id="featured-3">
    ...
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      ...
      <div class="feature col">
        ...
        <h3 class="fs-2 text-body-emphasis">Book Appointment</h3>
        <p>Create an appointment with your favorite and go to Veterinarian</p>
        <a href="#" class="btn btn-primary">Book Appointment Now</a>
      </div>
